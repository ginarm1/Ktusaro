  ...
  const renderPageNumbers = pageNumbers.map((number) => {
    return (
      <button
        ...
        className="mx-1 py-1 px-3 rounded-md font-medium text-sm text-white dark:bg-gray-500 hover:bg-gray-400 focus:outline-none focus:bg-indigo-500"
      >
        {number}
      </button>
    );
    ...
    if (currentPage === 1) {
      return (
        <div className="my-4 flex justify-center items-center">
          <ul className="mx-3 rounded-md bg-gray-300 dark:bg-gray-700">
            {renderPageNumbers}
          </ul>
        </div>
      );
    ...
    return (
      <div>
        <form
          ...
          className="flex md:w-2/3 items-center mx-10 py-3 px-5 sm:w-full bg-gray-50 dark:bg-gray-800 rounded-md dark:rounded-none shadow-md dark:shadow-none"
        >
          <label
            htmlFor="filterName"
            className="block font-medium  text-sm text-gray-700 dark:text-gray-50"
          >
            Filter by Name:
          </label>
          <input
          ...
          />
          <label
            htmlFor="filterEventCoordinatorName"
            className="hidden md:block pl-5 font-medium  text-sm text-gray-700 dark:text-gray-50"
          >
            Coordinator name:
          </label>
          <input
          ...
          />
          <label
            htmlFor="filterEventCoordinatorSurname"
            className="block pl-5 font-medium  text-sm text-gray-700 dark:text-gray-50"
          >
            Coordinator surname:
          </label>
          <input
          ...
          <Link
            ...
            className="text-white bg-green-400 border border-gray-300 focus:outline-none 
              hover:bg-gray-100 hover:text-black focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 ml-5 my-2
              dark:bg-green-900 dark:text-white  dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700"
          >
            Create
          </Link>
        </form>
          ...
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead className="text-xs text-gray-700 uppercase dark:text-gray-400">
              <tr>
                ...
                <th scope="col" className="px-6 py-3 sm:w-1/6">
                  Date
                </th>
                <th
                  scope="col"
              ...
              {events
                ...
                .filter((event) =>
                  event.coordinatorName
                    .toLowerCase()
                    .includes(filterEventCoordinatorName.toLowerCase())
                )
                .filter((event) =>
                  event.coordinatorSurname
                    .toLowerCase()
                    .includes(filterEventCoordinatorSurname.toLowerCase())
                )
                .sort((a, b) => b.id - a.id)
                .slice(
                  ...
                  >
                    ...
                    <td className="px-6 py-4 bg-gray-50 dark:bg-gray-800">
                      ...
                      <Link
                        ...
                        className="text-white bg-red-300 border border-gray-300 focus:outline-none 
